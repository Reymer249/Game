...
def task(keys_pressed, level, mistakes):
    ...
    if collide_task and click[0]:
        ...
        if level == 1:
            ...
            WINDOW.blit(mistake_text, (1000, 410)) # Currently there is a problem cause it keeps adding +1 to mistake counts if mouse button is pressed down, so often it will add more than one :/
